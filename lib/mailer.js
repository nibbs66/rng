...
exports.sendConfirmationEmail = function({toUser, toEmail, id, userRequest}){
    return new Promise((res, rej)=>{
        ...
        if(userRequest === 'username'){
            message = {
                ...
                <a>To retrieve your username, please follow on this link:</p> <a target="'_" href='${process.env.PUBLIC_URL}/reset/username/${id}'>Retrieve Username</a>
                <p>Bedankt,</p>
                <p>RnG Diving</p>
