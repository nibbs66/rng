   ...
   if(name==='color'){
    ...
    return (
        ...
        <div className={styles.container}>
            <Modal showModal={showModal} setShowModal={setShowModal} title={title} img={product.img[index]} pic={product.img} size={size} color={color} product={product} quantity={quantity}/>
            <Head>
            ...
            <div className={styles.top}>
                <div className={styles.left}>
                    <div className={styles.topImage}>
                        <Image className={styles.img} src={product.img[index]} alt="" height={350} width={350}  objectFit="contain" onClick={()=>{
                            setTitle('Photo')
                               setShowModal()
                        }}/>
                    </div>
                    ...
                    <div className={styles.thumbnail}>
                        {product.img.length > 1 && product.img.map((picture, idx)=>(
                            <Image className={styles.img} key={idx} value={idx} src={picture} alt="" height={100} width={100} objectFit="contain" onClick={()=>handlePhoto(idx)}/>
                        ))}
